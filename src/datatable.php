...
class Datatable{
	...
	public function __construct(mysqli $connectionString)
	{
		$this->dbobject = new DbObject($connectionString);
	}
	...
	public function generic_table($data,$table_name,$columner,$filter = "",$pk)
    {
		...
		$result   = $this->dbobject->db_query($sql);
	...
	{
		$pagination = $this->dbobject->db_query($sql_without_limit);
